...
if (isset($_POST['mobile'])) {
	...
	$query1 = "insert into transaction_details values('$receipt_no','$mobile','$sem','$amt_to_pay','$added_on','$payment_status','$payment_id')";
	mysqli_query($conn, $query1) or die('Couldnt perfrom query');
